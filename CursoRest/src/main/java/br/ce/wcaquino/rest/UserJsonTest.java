...
public class UserJsonTest {
	...
	public void deveVerificarPrimeiroNivelOutrasFormas() {
		...
		//PATH- abaixo faz a comparação entre dois objetos pegos no site
	...
	@Test
	public void devoFazerVerificacaoAvançadas() {
		given()
		.when()
		.get("http://restapi.wcaquino.me/users")
		.then()
		...
		//.body("salary.findAll{it!=null}.sum()",is(CloseTo(3734.5678f,0.001f)))
